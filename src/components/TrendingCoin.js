      ...
      {data ? (
        <>
          <h3 className="txt-base flex items-center my-0.5">
            ...
            <span className="border-gray-100">{data.name}</span>
            <img
              src={data.small}
              alt={data.name}
          ...
          <h3 className="txt-base flex items-center my-0.5">
            ...
            <span className="border-gray-100">{data.market_cap_rank}</span>
          </h3>
          <h3 className="txt-base flex items-center my-0.5">
            <span className="text-gray-100 capitalize">
              price (in btc):&nbsp;
          ...
          <h3 className="txt-base flex items-center my-0.5">
            ...
            <span className="border-gray-100">{data.score}</span>
          </h3>
...
"
        ...
        >
          <div
            className="w-8 h-8 border-4 border-gray-100 rounded-full
